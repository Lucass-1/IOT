// Projeto: Pote de Ração Automático com ESP32
// Componentes: ESP32, HC-SR04, Motor 28BYJ-48 + ULN2003, OLED I2C, Bot Telegram
...
void adicionarRacao() {
  ...
  enviarTelegram("🐾 Ração adicionada automaticamente.");
  stepper.setSpeed(10);
...
void setup() {
  ...
  while (WiFi.status() != WL_CONNECTED) {
    delay(500);
    mostrarOLED("Conectando Wi-Fi");
  }
  mostrarOLED("Wi-Fi Conectado");
  client.setInsecure();
  enviarTelegram("🤖 Sistema de ração iniciado.");
}
